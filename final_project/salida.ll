...
entry:
  ...
  %".7" = bitcast [2 x i8]* @"name_B" to i8*
  %".8" = call i32 (i8*, ...) @"printf"(i8* %".4", i32 2, i8* %".7", i32 5, i32 0, i32 0)
  %".9" = bitcast [2 x i8]* @"name_D" to i8*
  %".10" = call i32 (i8*, ...) @"printf"(i8* %".4", i32 3, i8* %".9", i32 8, i32 1, i32 30)
